       ...
       <div class="navigation">
        ...
        <header class="header">
            ...
            <div class="header__text-box">
                ...
                <a href="#" class="btn btn--white btn--animated">Admin</a>
                ...
                <div class="row">
                    ...
                    <div class="col-1-of-2">
                        <div class="composition">
                            ...
                            <img srcset="img/news3-1.jpg 300w, img/news3-1.jpg 100w" sizes="(max-width:56.25em) 20vw, (max-width: 37.5em) 30vw, 300px" alt="Photo1" class="composition__photo composition__photo--p1" src="img/news3-1.jpg">
                            <img srcset="img/news1-1.jpg 300w, img/news1-1.jpg 100w" sizes="(max-width:56.25em) 20vw, (max-width: 37.5em) 30vw, 300px" alt="Photo2" class="composition__photo composition__photo--p2" src="img/news1-1.jpg">
                            <img srcset="img/news2-1.jpg 300w, img/news2-1.jpg 100w" sizes="(max-width:56.25em) 20vw, (max-width: 37.5em) 30vw, 300px" alt="Photo3" class="composition__photo composition__photo--p3" src="img/news2-1.jpg">
<!--
                            <img src="img/news3.jpg" alt="Photo1" class="composition__photo composition__photo--p1">
                            <img src="img/news1.jpg" alt="Photo2" class="composition__photo composition__photo--p2">
                            <img src="img/news2.jpg" alt="Photo3" class="composition__photo composition__photo--p3">
                            -->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="book">
                        <div class="book__form">
                            <form action="#" class="form">
                                ...
                                <div class="form__group">
                                    <input type="email" class="form__input" placeholder="Contact Number" required>
                                    <label for="name" class="form__label">Contact Number</label>   
                                </div>
                                <div class="form__group">
        ...
        <footer class="footer" id="section-end">
            <div class="footer__logo-box">
                ...
                <picture class="footer__logo">
                    <source srcset="img/favicon.png 1x, img/favicon.png 2x" media="(max-width: 37.5em)">
                        <img srcset="img/favicon.png 1x, img/favicon.png 2x" alt="Full Logo"src="img/favicon.png ">
                </picture>
